...
export const metadata: Metadata = {
  ...
  description: 'Hypertension rarely causes symptoms until damage is done. Learn what the numbers mean, who is most at risk, and the proven steps that bring them down.',
  keywords: 'high blood pressure, hypertension, blood pressure control, cardiovascular health, primary care Cape Girardeau MO, hypertension management',
  openGraph: {
    title: 'High Blood Pressure: The Silent Killer You Can Control',
    description: 'Expert guidance on understanding and controlling hypertension from Guardian Primary Care.',
    url: 'https://www.guardianprimary.com/blog/high-blood-pressure-the-silent-killer-you-can-control',
    type: 'article',
  }
}
      ...
      <div className="bg-white pt-12">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative h-80 w-full overflow-hidden rounded-2xl">
            <Image
              src="/images/site/cond-hypertension.jpg"
              alt="A blood pressure cuff and monitor being used for a routine reading, illustrating regular hypertension monitoring"
              fill
      ...
      <article className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p className="mb-6">
              High blood pressure is one of the most common conditions in American adults, yet many people who have it do not know. That is why hypertension has earned its ominous nickname: the silent killer. But here is the empowering truth. While hypertension is dangerous, it is also one of the most controllable chronic conditions when it is properly managed. Understanding what it is, why it matters, and how to take control can literally save your life.
            </p>
          </div>
          ...
          <div className="font-display bg-[var(--color-light)] border-l-4 border-[var(--color-primary)] p-6 my-8 text-[var(--color-ink)] italic text-xl">
            Hypertension is one of the most significant modifiable risk factors for cardiovascular disease, and with proper management, most people can reach healthy blood pressure levels.
          </div>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p className="mb-6">
              Uncontrolled high blood pressure is a leading contributor to heart attack, stroke, heart failure, and chronic kidney disease. The damage is cumulative: every day your blood pressure remains elevated, your organs are under stress.
            </p>
            <p className="mb-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            <p className="mb-6">
              Decades of research have proven that controlling high blood pressure saves lives. Large clinical trials have shown that tighter blood pressure control lowers the risk of heart attack, heart failure, stroke, and death compared with looser targets. Your own target is set with your provider, based on your age, your other conditions, and how you tolerate treatment.
            </p>
            <p className="mb-6">
              Even modest reductions matter. Lowering systolic blood pressure by around 10 mm Hg, or diastolic by around 5 mm Hg, meaningfully reduces the risk of both heart disease and stroke. Over time, those reductions compound, protecting your brain, heart, kidneys, and eyes.
            </p>
            <p className="mb-6">
              The evidence is clear. Treating high blood pressure is not just about numbers on a monitor, it is about preserving your quality of life, preventing disability, and adding healthy years to your life.
            </p>
          </div>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            <p className="mb-6">
              If you have been diagnosed with high blood pressure, or if you have risk factors and have not had your blood pressure checked recently, it is time to see your primary care provider. Managing hypertension requires a partnership between you and your healthcare team.
            </p>
            <p className="mb-6">
              At Guardian Primary Care in Cape Girardeau, MO, we take a comprehensive, personalized approach to blood pressure management. We are in network with most major commercial insurances, Medicare and Medicaid, and Guardian Direct Care is available for patients who prefer transparent, predictable pricing. We will work with you to identify your risk factors, create a treatment plan that fits your life, monitor your progress, and adjust as needed. Our goal is not just to lower numbers, it is to protect your long-term health and help you live a full, active life.
            </p>
            <p className="mb-6">
            ...
            <p className="mb-6">
              Your heart, brain, and kidneys are counting on you. Call us at (573) 200-6143 and let us work together to keep them healthy for years to come.
            </p>
          </div>
      ...
      <section className="bg-[var(--color-cream)] py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <Link href="/blog/understanding-your-cholesterol-numbers-beyond-total-choleste" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
            ...
            <Link href="/blog/prediabetes-your-opportunity-to-prevent-type-2-diabetes" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
              <div className="bg-gradient-to-br from-[var(--color-light)] to-[var(--color-cream)] h-48 flex items-center justify-center">
                <svg className="w-16 h-16 text-[var(--color-primary)]" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl mb-8 text-white/90">
            Our care team in Cape Girardeau, MO is here to help you know your numbers and bring them down.
          </p>
          <div className="flex flex-wrap items-center justify-center gap-4">
            <Link
              href="/contact"
              className="inline-block bg-white text-[var(--color-primary)] px-8 py-4 rounded-full font-medium transition-all duration-300 shadow-lg hover:bg-[var(--color-cream)] hover:shadow-xl"
            >
              Schedule Your Visit
            </Link>
            <a
