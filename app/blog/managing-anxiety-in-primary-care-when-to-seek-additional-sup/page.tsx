...
export const metadata: Metadata = {
  title: 'Managing Anxiety in Primary Care: When to Seek Additional Support | Guardian Primary Care',
  description: 'Learn how primary care providers can help manage anxiety, recognize warning signs, and understand when additional mental health support may be beneficial for your wellbeing.',
  keywords: 'anxiety management, primary care mental health, anxiety treatment Birmingham AL, when to seek help for anxiety, mental health support',
}
      ...
      <article className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p className="mb-6">
              Anxiety disorders affect approximately 40 million American adults each year, making them the most common mental health condition in the United States. Yet despite their prevalence and treatability, only about one-third of those suffering receive treatment. Many people don't realize that their primary care provider can be an essential first step in addressing anxiety, or they're unsure when their symptoms warrant seeking help.
            </p>
            <p>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p className="mb-6">
              Primary care providers can screen for anxiety using validated questionnaires, provide initial counseling about lifestyle modifications, prescribe medications when appropriate, and coordinate care with mental health specialists if needed. In a direct primary care setting like Guardian Primary Care in Birmingham, AL, extended appointment times and ongoing relationships make it easier to address mental health concerns thoroughly and without rushed visits.
            </p>
            <p>
          ...
          <div className="bg-[var(--color-light)] border-l-4 border-[var(--color-primary)] p-6 my-8">
            <p className="text-[var(--color-ink)] italic text-xl font-serif">
              "The relationship you build with your primary care provider creates a safe space to discuss mental health concerns openly, without stigma or judgment—often the first step toward healing."
            </p>
          </div>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <div className="space-y-3 my-6">
              ...
              <div className="flex gap-3 items-start">
                ...
                <span>Avoidance behaviors that limit your life—skipping social events, refusing opportunities, or restricting activities</span>
              </div>
              <div className="flex gap-3 items-start">
                <svg className="w-6 h-6 text-[var(--color-accent)] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              ...
              <div className="flex gap-3 items-start">
                ...
                <span>Sleep disturbances—difficulty falling asleep, staying asleep, or experiencing restful sleep</span>
              </div>
              <div className="flex gap-3 items-start">
                <svg className="w-6 h-6 text-[var(--color-accent)] flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
              ...
              <div className="flex gap-3 items-start">
                ...
                <span>Panic attacks—sudden episodes of intense fear with physical symptoms like heart palpitations and feeling out of control</span>
              </div>
            </div>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p>
              In Birmingham, AL, Guardian Primary Care works closely with trusted mental health professionals in the community, making referrals and care coordination seamless when additional support is needed.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-[var(--color-muted)] text-sm">
                  Learn why routine mental health screenings are essential to your overall wellness plan.
                </p>
              </div>
            </a>
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <p className="text-[var(--color-muted)] text-sm">
                  Evidence-based strategies for reducing daily stress and building resilience.
                </p>
              </div>
            </a>
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                ...
                <h4 className="font-serif text-xl text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-primary)] transition-colors">
                  The Sleep-Anxiety Connection: Breaking the Cycle
                </h4>
                <p className="text-[var(--color-muted)] text-sm">
                  Understanding how poor sleep fuels anxiety and what you can do about it.
                </p>
              </div>
            </a>
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <p className="text-xl text-white/90 mb-8">
            Our team is here to help you manage anxiety and improve your overall wellbeing.
          </p>
          <a 
            href="/contact" 
