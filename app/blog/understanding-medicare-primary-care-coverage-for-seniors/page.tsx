...
export const metadata: Metadata = {
  title: 'Understanding Medicare: Primary Care Coverage for Seniors | Guardian Primary Care',
  description: 'Comprehensive guide to Medicare coverage for primary care services. Learn about Parts A, B, C, D, and how to maximize your benefits as a senior in Birmingham, AL.',
  openGraph: {
    title: 'Understanding Medicare: Primary Care Coverage for Seniors',
    description: 'Comprehensive guide to Medicare coverage for primary care services. Learn about Parts A, B, C, D, and how to maximize your benefits as a senior.',
    type: 'article',
      ...
      <article className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-6">
            <p className="mb-6">
              Medicare is a federal health insurance program that primarily serves Americans aged 65 and older. However, eligibility isn't limited by age alone—certain younger individuals with disabilities or specific health conditions like End-Stage Renal Disease (ESRD) or ALS also qualify.
            </p>
            <p className="mb-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-6">
            ...
            <p className="mb-6">
              <strong>Part B (Medical Insurance)</strong> is where primary care coverage really shines. This part covers doctor visits, outpatient care, preventive services, and medical equipment. Your annual wellness visits, screenings, and routine checkups with your primary care physician are all covered under Part B. In 2024, the standard Part B premium is $174.70 per month, though higher earners may pay more based on income-related adjustments.
            </p>
            <p className="mb-6">
          ...
          <blockquote className="bg-[var(--color-light)] border-l-4 border-[var(--color-primary)] p-6 my-8 text-[var(--color-ink)] italic text-xl font-serif" style={{ fontFamily: 'Cormorant, serif' }}>
            "Medicare Part B covers 100% of preventive care services when you see an in-network provider, including your annual wellness visit, most screenings, and many vaccines—with no copayment or deductible."
          </blockquote>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-6">
            ...
            <p className="mb-6">
              For Part B services, after you meet your annual deductible ($240 in 2024), you'll typically pay 20% of the Medicare-approved amount for most doctor visits and services. This is where many seniors choose to purchase supplemental insurance (Medigap) to help cover these costs.
            </p>
            <p className="mb-6">
              Medicare Advantage plans often work differently, with copayments for office visits (commonly $0-$40 per visit) instead of coinsurance. Many seniors find the predictability of copayments easier to budget than the percentage-based coinsurance of Original Medicare.
            </p>
            <p className="mb-6">
              One important consideration: preventive services are typically covered at 100% with no cost-sharing, but if your doctor finds a problem during a preventive visit and provides treatment, that additional service may be subject to normal cost-sharing rules.
            </p>
          </div>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-6">
            ...
            <p className="mb-6">
              <strong>Original Medicare</strong> offers the greatest flexibility in choosing healthcare providers. You can see any doctor or specialist who accepts Medicare anywhere in the United States, without needing referrals. This makes it ideal if you travel frequently, split time between different locations, or want to preserve maximum choice in your healthcare providers.
            </p>
            <p className="mb-6">
            ...
            <p className="mb-6">
              Your choice depends on your individual circumstances: your health status, budget, preferred doctors, and whether you value flexibility over comprehensive coverage. In Birmingham, there are numerous Medicare Advantage plans available, and it's worth comparing them carefully during your enrollment period.
            </p>
          </div>
          ...
          <div className="space-y-4 mb-8">
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="text-[var(--color-ink)] leading-relaxed">
                <strong>Take advantage of preventive screenings.</strong> From cardiovascular disease screening to cancer screenings, these services are covered at 100%. Early detection saves lives and reduces healthcare costs long-term.
              </div>
            </div>
            ...
            <div className="flex gap-4 items-start">
              ...
              <div className="text-[var(--color-ink)] leading-relaxed">
                <strong>Establish a relationship with a primary care provider.</strong> Continuity of care leads to better health outcomes. Your primary care doctor becomes familiar with your health history and can coordinate all aspects of your care.
              </div>
            </div>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mt-12 mb-6">
            ...
            <p className="mb-6">
              Whether you're approaching 65 or already enrolled in Medicare, having a trusted primary care provider who understands the nuances of Medicare coverage can make all the difference. At Guardian Primary Care in Birmingham, our team has extensive experience helping Medicare patients navigate their coverage, maximize their benefits, and receive the comprehensive, personalized care they deserve.
            </p>
            <p>
              If you have questions about your Medicare coverage or are looking for a primary care provider who accepts Medicare, we're here to help. Our patient-centered approach ensures that you receive the time, attention, and expertise you need to maintain optimal health throughout your senior years.
            </p>
          </div>
          ...
          <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start animate-fade-up">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] leading-relaxed">
                Board-certified providers specializing in Primary Care and Direct Primary Care (DPC), dedicated to delivering personalized, comprehensive healthcare to the Birmingham community.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up">
              ...
              <div className="p-6">
                ...
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Learn which preventive screenings you need at every age and how they can help detect health issues early.
                </p>
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up" style={{ animationDelay: '100ms' }}>
              ...
              <div className="p-6">
                ...
                <h4 className="font-serif text-xl text-[var(--color-ink)] mb-3 group-hover:text-[var(--color-primary)] transition-colors" style={{ fontFamily: 'Cormorant, serif' }}>
                  Managing Diabetes: Your Primary Care Partner
                </h4>
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Discover how working closely with your primary care provider can help you successfully manage diabetes.
                </p>
                <div className="text-[var(--color-accent)] text-sm font-medium flex items-center gap-2">
                  Read Article
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <a href="/blog" className="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="p-6">
                ...
                <h4 className="font-serif text-xl text-[var(--color-ink)] mb-3 group-hover:text-[var(--color-primary)] transition-colors" style={{ fontFamily: 'Cormorant, serif' }}>
                  What Is Direct Primary Care and Is It Right for You?
                </h4>
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Explore the Direct Primary Care model and learn how it's transforming the patient-doctor relationship.
                </p>
                <div className="text-[var(--color-accent)] text-sm font-medium flex items-center gap-2">
                  Read Article
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Our team is here to help you navigate Medicare and receive the personalized primary care you deserve.
          </p>
          <a 
            href="/contact" 
