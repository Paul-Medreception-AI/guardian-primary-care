...
export const metadata: Metadata = {
  title: 'Understanding Your Cholesterol Numbers: Beyond Total Cholesterol | Guardian Primary Care',
  description: 'Learn what your cholesterol numbers really mean. Discover the difference between HDL, LDL, and triglycerides and why total cholesterol doesn\'t tell the whole story.',
  keywords: 'cholesterol levels, HDL cholesterol, LDL cholesterol, triglycerides, heart health, cholesterol testing, Birmingham AL primary care',
  openGraph: {
      ...
      <article className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            <p className="mb-6">
              You just received your lab results, and there it is: your total cholesterol number. Maybe it's higher than you'd like, or perhaps it looks perfectly normal. But here's something most people don't realize—that single number on your lab report is only telling you part of the story. In fact, focusing solely on total cholesterol can be misleading and might cause you to miss crucial information about your actual heart health risk.
            </p>
            <p className="mb-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <div className="space-y-3 my-6">
              ...
              <div className="flex gap-3">
                ...
                <p><strong>Maintain a healthy weight</strong>—losing even 5-10% of body weight can significantly improve cholesterol levels if you're overweight.</p>
              </div>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p className="mb-6">
              At Guardian Primary Care in Birmingham, AL, we believe in taking the time to thoroughly explain your lab results and work with you to develop a heart-health plan that fits your life. Whether you need help interpreting your numbers, implementing lifestyle changes, or determining if medication is right for you, we're here to support you every step of the way.
            </p>
            <p>
              Don't let confusing numbers keep you from taking action. Schedule a consultation to review your cholesterol profile and create a personalized plan for optimal heart health.
            </p>
          </div>
        </div>
        ...
        <div className="bg-[var(--color-cream)] rounded-2xl p-8 max-w-3xl mx-auto my-12 flex gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-[var(--color-muted)] text-sm leading-relaxed">
              Board-certified providers specializing in Primary Care / DPC, dedicated to delivering personalized, evidence-based healthcare to the Birmingham community.
            </p>
          </div>
        </div>
      </article>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <a href="/blog" className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Learn how to interpret your blood pressure readings and take proactive steps to maintain cardiovascular health.
                </p>
            ...
            <a href="/blog" className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-3 group-hover:text-[var(--color-primary)] transition-colors">
                  Pre-Diabetes: Catching It Early and Reversing Course
                </h4>
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Discover the warning signs of pre-diabetes and evidence-based strategies to prevent progression to type 2 diabetes.
                </p>
                <div className="text-[var(--color-primary)] text-sm font-medium flex items-center gap-2">
                  Read Article
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
            ...
            <a href="/blog" className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-3 group-hover:text-[var(--color-primary)] transition-colors">
                  The Mediterranean Diet: Heart Health Made Delicious
                </h4>
                <p className="text-[var(--color-muted)] text-sm leading-relaxed mb-4">
                  Explore the science-backed benefits of Mediterranean eating and simple ways to incorporate it into your lifestyle.
                </p>
                <div className="text-[var(--color-primary)] text-sm font-medium flex items-center gap-2">
                  Read Article
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-white/90 mb-8 leading-relaxed">
            Our team is here to help you understand your cholesterol numbers and create a personalized plan for optimal heart health.
          </p>
          <a 
            href="/contact" 
