...
export const metadata: Metadata = {
  title: 'Managing Chronic Pain Without Opioids: Alternative Approaches | Guardian Primary Care',
  description: 'Discover evidence-based alternatives to opioid therapy for chronic pain management. Learn about physical therapy, cognitive behavioral therapy, lifestyle modifications, and integrative approaches from our Birmingham primary care team.',
  keywords: 'chronic pain management, opioid alternatives, pain treatment Birmingham AL, non-opioid pain relief, physical therapy, cognitive behavioral therapy, integrative pain management, primary care Birmingham',
  openGraph: {
    title: 'Managing Chronic Pain Without Opioids: Alternative Approaches',
    description: 'Evidence-based alternatives to opioid therapy for chronic pain management from Guardian Primary Care in Birmingham, AL.',
    type: 'article',
    ...
    <main className="min-h-screen bg-white">
      ...
      <article className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p className="mb-6">
              Common conditions causing chronic pain include arthritis, fibromyalgia, neuropathy, back and neck injuries, migraines, and autoimmune disorders. In Birmingham and across the United States, an estimated 50 million adults live with chronic pain—making it one of the most common reasons people seek medical care.
            </p>
          </div>
          ...
          <blockquote className="bg-[var(--color-light)] border-l-4 border-[var(--color-primary)] p-6 my-8 text-[var(--color-ink)] italic text-xl" style={{fontFamily: 'Cormorant, serif'}}>
            "Pain management is not about eliminating all discomfort—it's about reducing pain to a level that allows you to function, engage in activities you value, and maintain quality of life."
          </blockquote>
          ...
          <div className="text-[var(--color-ink)] leading-loose text-base mb-8">
            ...
            <p className="mb-6">
              At Guardian Primary Care in Birmingham, we take a comprehensive, patient-centered approach to chronic pain management. We work closely with you to develop a personalized plan that addresses not just your pain, but the impact it has on your daily life, mental health, and overall wellbeing. Our direct primary care model allows us the time to truly understand your experience and support you through the process of finding effective, sustainable solutions.
            </p>
            <p className="mb-6">
      ...
      <div className="max-w-3xl mx-auto px-6 my-12">
        <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start">
          ...
          <div>
            ...
            <p className="text-[var(--color-muted)] leading-relaxed">Board-certified providers specializing in Primary Care / DPC, committed to delivering personalized, comprehensive healthcare to the Birmingham community.</p>
          </div>
        </div>
      </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <a href="/blog" className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-primary)] transition-colors" style={{fontFamily: 'Cormorant, serif'}}>Understanding Your Blood Pressure Numbers</h4>
                <p className="text-[var(--color-muted)] text-sm">Learn what your blood pressure readings mean and how to maintain healthy levels.</p>
              </div>
            </a>
            ...
            <a href="/blog" className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-primary)] transition-colors" style={{fontFamily: 'Cormorant, serif'}}>Managing Stress and Anxiety in Daily Life</h4>
                <p className="text-[var(--color-muted)] text-sm">Practical strategies for coping with stress and improving mental wellbeing.</p>
              </div>
            </a>
            ...
            <a href="/blog" className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group">
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-primary)] transition-colors" style={{fontFamily: 'Cormorant, serif'}}>The Importance of Sleep for Overall Health</h4>
                <p className="text-[var(--color-muted)] text-sm">Discover how quality sleep impacts your physical and mental health.</p>
              </div>
            </a>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl mb-8 text-white/90">Our team is here to help you manage chronic pain effectively.</p>
          <a 
            href="/contact" 
