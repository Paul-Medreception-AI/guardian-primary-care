...
export const metadata: Metadata = {
  title: 'Supporting Caregivers: Resources for Families Caring for Dementia Patients | Guardian Primary Care',
  description: 'Comprehensive guide for family caregivers supporting loved ones with dementia. Evidence-based strategies, local resources, and practical tips from Guardian Primary Care in Birmingham, AL.',
  openGraph: {
    title: 'Supporting Caregivers: Resources for Families Caring for Dementia Patients',
    description: 'Comprehensive guide for family caregivers supporting loved ones with dementia. Evidence-based strategies, local resources, and practical tips from Guardian Primary Care.',
    type: 'article',
        ...
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="text-base leading-loose text-[var(--color-ink)]">
            ...
            <div className="bg-[var(--color-cream)] border-l-4 border-[var(--color-primary)] p-6 my-8 rounded-r-lg">
              <h3 className="font-semibold text-[var(--color-ink)] mb-3">Key Support Resources in Birmingham, AL:</h3>
              <ul className="space-y-2 text-[var(--color-ink)]">
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span><strong>Alzheimer's of Central Alabama</strong> — Local chapter offering support groups, education programs, and care consultations</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span><strong>Area Agency on Aging</strong> — Provides information on respite care, adult day programs, and in-home services</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                  </svg>
                  <span><strong>Alabama Medicaid Waiver Programs</strong> — May provide financial assistance for home and community-based services</span>
                </li>
                <li className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-[var(--color-primary)] flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
          ...
          <div className="text-base leading-loose text-[var(--color-ink)]">
            ...
            <div className="bg-[var(--color-light)] border-l-4 border-[var(--color-primary)] p-6 my-8 rounded-r-lg">
              <p className="italic text-xl text-[var(--color-ink)]" style={{ fontFamily: 'Cormorant, serif' }}>
          ...
          <div className="text-base leading-loose text-[var(--color-ink)]">
            ...
            <p className="mb-4">
              Maintain your own healthcare appointments. Caregiver health often deteriorates from neglect rather than lack of access. Stay current with preventive care, manage chronic conditions, and address new symptoms promptly. At Guardian Primary Care in Birmingham, we understand the unique health challenges caregivers face and can coordinate your care alongside your loved one's needs.
            </p>
            <p className="mb-6">
          ...
          <div className="text-base leading-loose text-[var(--color-ink)]">
            ...
            <p className="mb-4">
              Legal and financial planning should address powers of attorney for healthcare and finances, advance directives, and long-term care funding. Alabama residents should consult an elder law attorney familiar with state-specific regulations around Medicaid planning and estate considerations.
            </p>
            <p className="mb-4">
          ...
          <div className="bg-[var(--color-light)] border-l-4 border-[var(--color-primary)] p-6 my-8 rounded-r-lg">
            <p className="text-base leading-relaxed text-[var(--color-ink)]">
              <strong>If you're caring for a loved one with dementia in Birmingham, you don't have to navigate this journey alone.</strong> Guardian Primary Care provides comprehensive support for both patients and their caregivers, including medication management, care coordination, and connections to community resources. Our direct primary care model means you have ready access to your healthcare team when questions or concerns arise. We're here to support your entire family through this challenging time.
            </p>
          </div>
        </div>
      </article>
        ...
        <div className="max-w-3xl mx-auto px-6">
          <div className="bg-[var(--color-cream)] rounded-2xl p-8 flex gap-6 items-start animate-fade-up">
            ...
            <div>
              ...
              <p className="text-[var(--color-muted)] mb-3">Board-certified providers specializing in Primary Care / DPC</p>
              <p className="text-[var(--color-ink)] leading-relaxed">
                Our experienced team is dedicated to providing comprehensive, compassionate care for patients and families throughout Birmingham, AL. We believe in taking the time to understand your unique needs and building lasting relationships centered on your health and wellbeing.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <a href="/blog" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up">
              ...
              <div className="p-6">
                <div className="text-xs uppercase tracking-wider text-[var(--color-muted)] mb-2">Chronic Disease Management</div>
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-primary)] transition-colors" style={{ fontFamily: 'Cormorant, serif' }}>
                  Understanding Alzheimer's Disease: Early Signs and When to Seek Help
                </h4>
            ...
            <a href="/blog" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up" style={{ animationDelay: '100ms' }}>
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-primary)] transition-colors" style={{ fontFamily: 'Cormorant, serif' }}>
                  Preventing Caregiver Burnout: Recognizing Warning Signs
                </h4>
                <p className="text-[var(--color-muted)] text-sm">
                  Learn to identify the physical and emotional symptoms of burnout before it impacts your health and caregiving ability.
                </p>
              </div>
            </a>
            ...
            <a href="/blog" className="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 animate-fade-up" style={{ animationDelay: '200ms' }}>
              ...
              <div className="p-6">
                ...
                <h4 className="text-xl font-semibold text-[var(--color-ink)] mb-2 group-hover:text-[var(--color-primary)] transition-colors" style={{ fontFamily: 'Cormorant, serif' }}>
                  Creating a Safe Home Environment for Memory Care
                </h4>
                <p className="text-[var(--color-muted)] text-sm">
                  Practical modifications to reduce fall risk, prevent wandering, and support independence for as long as possible.
                </p>
              </div>
            </a>
          </div>
      ...
      <section className="bg-gradient-to-br from-[var(--color-dark)] to-[var(--color-primary)] py-20 text-white text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl text-white/90 mb-8">
            Our team is here to help you and your family navigate this journey with compassion and expertise.
          </p>
          <a 
            href="/contact" 
