      ...
      <section className="bg-white py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              This website (the &quot;Site&quot;) is owned and operated by Guardian Primary Care (&quot;COMPANY,&quot; &quot;we&quot; or &quot;us&quot;). By using the Site, you agree to be bound by these Terms of Service and to use the Site in accordance with these Terms of Service, our Privacy Policy, and any additional terms and conditions that may apply to specific sections of the Site or to products and services available through the Site or from Guardian Primary Care.
            </p>
            <p className="text-[var(--color-muted)] mb-6">
            ...
            <p className="text-[var(--color-muted)] mb-6">
              This Site and all the materials available on the Site are the property of Guardian Primary Care and/or our affiliates or licensors and are protected by copyright, trademark, and other intellectual property laws. The Site is provided solely for your personal non-commercial use.
            </p>
            <p className="text-[var(--color-muted)] mb-6">
